...
out_dir = '../new_out/tip-add-s-(32-16)-(64-16-64-32-16)'
...
class FMEncoder(torch.nn.Module):
    ...
    def __init__(self, device, in_dim_drug, num_dd_et, in_dim_prot,
                 ...
                 num_base=16, n_embed=64, n_hid1=32, n_hid2=16, mod='cat'):
        '''
        :param device:
        :param in_dim_drug:
        :param num_dd_et:
...
def train():
    ...
    neg_index = negative_sampling(data.dd_train_idx, data.n_drug, data.dd_train_range).to(device)
